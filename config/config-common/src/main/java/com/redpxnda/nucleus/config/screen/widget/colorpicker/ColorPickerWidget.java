...
public class ColorPickerWidget extends AbstractWidget {
    ...
    public boolean mouseDragged(double mouseX, double mouseY, int button, double deltaX, double deltaY) {
        if (colorGrid.isDragging(mouseX, mouseY) && colorGrid.mouseDragged(mouseX, mouseY, button, deltaX, deltaY)) return true;
        if (hueSlider.isDragging(mouseX, mouseY) && hueSlider.mouseDragged(mouseX, mouseY, button, deltaX, deltaY)) return true;
        if (alphaSlider.isDragging(mouseX, mouseY) && alphaSlider.mouseDragged(mouseX, mouseY, button, deltaX, deltaY)) return true;
